...
class QLearningSolver():
    ...
    def __init__(self):
        rospy.loginfo("Init QLearningSolver class ...")
        self.env = gym.make('CartPoleStayUp-v0').unwrapped
        self.showExampleScreen()
...
if __name__ == '__main__':
    ...
    print "Testing Reinforcement algorithm"
    test_q_rl = QLearningSolver()
    test_q_rl.RunSolver()
    rospy.spin()